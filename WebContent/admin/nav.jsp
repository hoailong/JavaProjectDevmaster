        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="<%=request.getContextPath()%>/logout"><i class="fa fa-fw fa-power-off"></i>Log Out</a>
                        </li>
                    </ul>
                </li>
            </ul>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="<%=request.getContextPath()%>/admin-foodGroups"><i class="fas fa-layer-group"></i> Food Group</a>
                    </li>
                    <li>
                        <a href="<%=request.getContextPath()%>/admin-foods"><i class="fas fa-utensils"></i> Foods</a>
                    </li>
                    <li>
                        <a href="<%=request.getContextPath()%>/admin-tables"><i class="fas fa-table"></i> Tables</a>
                    </li>
                    <li>
                        <a href="<%=request.getContextPath()%>/admin-times"><i class="far fa-clock"></i> Times</a>
                    </li>
                    <li>
                        <a href="<%=request.getContextPath()%>/admin-orders"><i class="fas fa-cart-plus"></i> Orders</a>
                    </li>
                    <li>
