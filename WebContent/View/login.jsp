<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
    ...
    <body>
      <div class="limiter">
        <div class="container-login100" style="background-image: url('<%=request.getContextPath()%>/resources/images/bg-01.jpg');">
          <div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
            <form class="login100-form validate-form flex-sb flex-w" action="<%=request.getContextPath()%>/login" method="POST">
              ...
              <a href="#" class="btn-google m-b-20">
						<img src="<%=request.getContextPath()%>/resources/images/icons/icon-google.png" alt="GOOGLE">
						Google
					</a>
              <div style="width:100%;color:red;text-align:center;">
                <span><c:if test="${not empty error}">${error}</c:if></span>
              </div>
              ...
              <div class="w-full text-center p-t-55">
                ...
                <a href="<%=request.getContextPath()%>/register" class="txt2 bo1">
							Sign up now
						</a>
              </div>
            </form>
